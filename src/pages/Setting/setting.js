...
import { FaUser, FaCog, FaBell, FaShieldAlt, FaPalette, FaSignOutAlt, FaCode, FaMoon, FaSun } from "react-icons/fa";
...
const Setting = () => {
    ...
    const renderGeneralSection = () => (
        <div className="general-section fade-in">
            ...
            <div className="settings-group">
                <div className="setting-item hover-lift">
                    ...
                    <select className="setting-control focus-ring">
    ...
    const renderSecuritySection = () => (
        <div className="security-section fade-in">
            ...
            <div className="settings-group">
                <div className="setting-item hover-lift">
                    ...
                    <button className="enable-btn hover-lift">Enable</button>
                </div>
                ...
                <div className="setting-item hover-lift">
                    ...
                    <button className="change-btn hover-lift">Change</button>
                </div>
            </div>
        </div>
    );
    ...
    const renderAppearanceSection = () => (
        <div className="appearance-section fade-in">
        ...
        <div className="api-management-section fade-in">
            ...
            <div className="settings-group">
                <div className="setting-item hover-lift">
                    ...
                    <button className="manage-btn hover-lift">Manage Keys</button>
                </div>
                ...
                <div className="setting-item hover-lift">
                    ...
                    <button className="configure-btn hover-lift">Configure</button>
                </div>
                ...
                <div className="setting-item hover-lift">
                    ...
                    <button className="setup-btn hover-lift">Setup Webhooks</button>
                </div>
                ...
                <div className="setting-item hover-lift">
                    ...
                    <button className="analytics-btn hover-lift">View Analytics</button>
                </div>
                ...
                <div className="setting-item hover-lift">
                    ...
                    <button className="docs-btn hover-lift">View Docs</button>
                </div>
            </div>
        </div>
    );
